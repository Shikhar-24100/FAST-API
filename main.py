...
def create_patient(patient: Patient):
    ...
    #check for duplication in PATIENT ID
    ...
    #save into the json file(our db for now)
    save_data(data)


    return JSONResponse(status_code=201, content={'message': 'aptient created successfully'})
